      ...
      <div className="px-4 py-1 border-t border-gray-100 flex items-center justify-between">
        <div className="flex w-full">
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2 font-semibold text-sm rounded-md transition ${showComments ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:bg-gray-100'
              }`}
          >
